...
#to add the variable of copper: presence/absence
H2O2N <- H2O2_means$Trt > 1 & H2O2_means$Trt < 5 #create a vector true/false: false if Trt == 1 😊 control without Copper)
...
#Adding a column with 100 mg/L 
GR1$Hundred.mg.DOC <- GR1$Variant ==4 | GR1$Variant ==5 | GR1$Variant ==7 | GR1$Variant ==8
